			...
			<form class="ui  form log" method="post" action="/HospDBMS/Plogin">
				<div class="field">
					<div class="sixteen wide field">
						<br> <label class="header">User Name</label> <input
							type="text" name="uname" placeholder="username">
					</div>
				</div>
				<div class="field">
					<div class="sixteen wide field">
						<label class="ui header">Password</label> <input type="password"
				...
				<div class="field">
					<p class="header">
						Don't have an account? <a href="newuser.html" id="field1">Create
							account</a>
					</p>
