...
<body
	style="background-image: url(https://www.elegantthemes.com/blog/wp-content/uploads/2013/09/bg-9-full.jpg)">
	<div id="app">
										...
										<div class="panel-body">
											<form method="post" action="successbapn.jsp">
												...
												<div class="form-group">
													<label for="DoctorSpecialization"> Doctor
														Specialization </label> <select name="dspec" class="form-control"
														required="required">
												...
												<div class="form-group">
													<label for="doctor"> Doctors </label> <select name="dname"
												...
												<div class="form-group">
													<label for="AppointmentDate"> Date </label> <input
														class="form-control datepicker" name="date"
														required="required" data-date-format="yyyy-mm-dd"><b>Format:
														YYYY-MM-DD</b>

												</div>

												<div class="form-group">
													<label for="Appointmenttime"> Time </label> <input
														class="form-control" name="time" id="timepicker1"
														required="required"><b>Format: HH:MM:SS in
														24hr format</b>
												</div>
